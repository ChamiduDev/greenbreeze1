              ...
              <Image
                ...
                className={`object-contain transition-all duration-300 ${
                  isScrolled
                    ...
                    : "w-28 sm:w-36 drop-shadow-[0_4px_24px_rgba(255,255,255,0.3)] brightness-110"
                }`}
              />
            </motion.div>
          </Link>
          ...
          <div className="flex items-center space-x-6">
            ...
            >
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className={`px-8 py-3 rounded-full font-playfair font-semibold text-sm tracking-widest uppercase transition-all duration-300 shadow-xl ${
                  isScrolled
...
function NavLink({ link, isScrolled }: { link: (typeof NAV_LINKS)[0]; isScrolled: boolean }) {
  ...
  return (
    <Link
      ...
      className={`relative py-2 font-playfair font-medium text-[15px] tracking-wide transition-colors duration-300 ${
        isScrolled
    ...
    >
      ...
      <motion.span
        ...
        className={`absolute bottom-0 left-0 w-full h-[2px] origin-left ${
          isScrolled ? "bg-brand-secondary" : "bg-brand-accent"
        }`}
      />
    </Link>
  );
